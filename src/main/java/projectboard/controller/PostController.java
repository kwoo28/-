...
public class PostController {
    ...
    public void createUser(Authentication authentication, @Valid @RequestBody CreatePostReqDto createPostReqDto){
        Long userId = Long.parseLong(authentication.getName());
        postService.createPost(userId, createPostReqDto);
    }
